                ...
                <div class="card-body text-left">
                    ...
                    <form method="POST" action="<?php echo e(route('employees.store')); ?>">
                        ...
                        <div class="form-group">
                            <label for="name">Name <i>{jangan pakai spasi}</i></label>
                            <input type="text" class="form-control" placeholder="Enter a Employee name [hyphen accepted]" id="name" name="name"
                                required />
                        </div>
                        <div class="form-group">
                            <label for="position">Position <i>{jangan pakai spasi}</i></label>
...
</div><?php /**PATH D:\AttendanceMS-Laravel\resources\views/includes/add_employee.blade.php ENDPATH**/ ?>